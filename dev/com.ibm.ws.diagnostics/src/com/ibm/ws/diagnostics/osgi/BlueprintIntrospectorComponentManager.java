 ...
 *
 */
public class BlueprintIntrospectorComponentManager implements ComponentManager {

    @Override
    public ReturnValue activate(Object instance, ComponentContext componentContext) {
        ((BlueprintIntrospector) instance).activate(componentContext.getBundleContext());
