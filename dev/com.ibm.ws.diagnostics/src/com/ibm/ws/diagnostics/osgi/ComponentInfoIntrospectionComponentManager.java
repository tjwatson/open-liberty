 ...
 *
 */
public class ComponentInfoIntrospectionComponentManager implements ComponentManager {
    ...
    public ReturnValue bind(Object instance, String name, Parameters parameters) {
        if ("setScrInfo".equals(name)) {
            Object[] params = parameters.getParameters(ScrInfo.class);
            ((ComponentInfoIntrospection) instance).setScrInfo((ScrInfo) params[0]);
        }
        return ReturnValue.VOID;
    }
    ...
    public ReturnValue unbind(Object instance, String name, Parameters parameters) {
        if ("unsetScrInfo".equals(name)) {
            Object[] params = parameters.getParameters(ScrInfo.class);
            ((ComponentInfoIntrospection) instance).unsetScrInfo((ScrInfo) params[0]);
        }
        return ReturnValue.VOID;
    }
