 ...
 *
 */
public class FileNotificationComponentManager implements ComponentManager {
    ...
    public ReturnValue bind(Object instance, String name, Parameters parameters) {
        if ("setNotificationDelegate".equals(name)) {
            Object[] params = parameters.getParameters(FileNotification.class);
            ((FileNotificationImpl) instance).setNotificationDelegate((FileNotification) params[0]);
        }
        return ReturnValue.VOID;
    }
    ...
    public ReturnValue unbind(Object instance, String name, Parameters parameters) {
        if ("unsetNotificationDelegate".equals(name)) {
            Object[] params = parameters.getParameters(FileNotification.class);
            ((FileNotificationImpl) instance).unsetNotificationDelegate((FileNotification) params[0]);
        }
        return ReturnValue.VOID;
    }
