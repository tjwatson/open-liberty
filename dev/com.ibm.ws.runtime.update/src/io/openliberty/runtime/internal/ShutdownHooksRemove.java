 ...
 *
 */
@Component(property = { "service.vendor=IBM", "osgi.jndi.service.name=" + LibertyRuntimeConstants.RUNTIME_SHUTDOWN_HOOKS_REMOVE_JNDI_NAME,
                        "osgi.jndi.service.class=java.util.function.Consumer" })
public class ShutdownHooksRemove implements Consumer<Runnable> {

    private final LibertyRuntime runtime;

    @Activate
    public ShutdownHooksRemove(@Reference LibertyRuntime runtime) {
