 ...
 *
 */
public class FutureMonitorComponentManager implements ComponentManager {
    ...
    public ReturnValue bind(Object instance, String name, Parameters parameters) {
        if ("setExecutor".equals(name)) {
            ...
            ((FutureMonitorImpl) instance).setExecutor((ScheduledExecutorService) params[0]);
        }
        return ReturnValue.VOID;
    }
    ...
    public ReturnValue unbind(Object instance, String name, Parameters parameters) {
        if ("unsetExecutor".equals(name)) {
            Object[] params = parameters.getParameters(ScheduledExecutorService.class);
            ((FutureMonitorImpl) instance).unsetExecutor((ScheduledExecutorService) params[0]);
        }
        return ReturnValue.VOID;
    }
